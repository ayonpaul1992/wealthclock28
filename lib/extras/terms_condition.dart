...
class _TermsCondPageState extends State<TermsCondPage> {
  Future<void> _launchURL() async {
    final Uri url = Uri.parse('https://wealthclockadvisors.com/');
    if (!await launchUrl(
      url,
                    ...
                    Wrap(
                      ...
                      children: [
                        Text.rich(
                          TextSpan(
                            text:
                                "Terms and Conditions of Use and its acceptance",
                    ...
                    Wrap(
                      ...
                      children: [
                        Text.rich(
                          TextSpan(
                            text:
                                "Third Party Service providers and Links to Website",
                            style: GoogleFonts.poppins(
                              fontSize: 17,
                              fontWeight: FontWeight.w600,
                              color: Color(0xFF09a99d),
                        ...
                        Text.rich(
                          TextSpan(
                            ...
                            children: [
                              ...
                              TextSpan(
                                text:
                                    ' if you assign or transfer (or attempt the same) any rights granted to you under this Agreement; (c) immediately, if you violate any of the other terms and conditions of this User Agreement. Termination or cancellation of this Agreement shall not affect any right or relief to which wealthclockadvisors.com may be entitled, at law or in equity. Upon termination of this User Agreement, all rights granted to you will terminate and revert to ',
                                style: GoogleFonts.poppins(
                                  color: Color(0xFF0f625c),
                                  fontSize: 13,
                                  fontWeight: FontWeight.w400,
                              ...
                              TextSpan(
                                text:
                                    '. Except as set forth herein, regardless of the reason for cancellation or termination of this User Agreement, the fee charged if any for access to wealthclockadvisors.com is non-refundable for any reason.',
                                style: GoogleFonts.poppins(
                                  color: Color(0xFF0f625c),
                                  fontSize: 13,
                                  fontWeight: FontWeight.w400,
