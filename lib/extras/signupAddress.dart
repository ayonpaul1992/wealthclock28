...
class _SignupAddressPageState extends State<SignupAddressPage> {
  ...
  final TextEditingController jointHolderPanText = TextEditingController();
  ...
  List<String> dropdownItems = ["Single", "Joint", "Anyone or Survivor"];
  ...
  void deleteSavedNominee(int index) {
    setState(() {
      if (index >= 0 && index < savedNominees.length) {
        int removedShare =
            int.tryParse(savedNominees[index]['share'] ?? '0') ?? 0;
              ...
              Container(
                child: Wrap(
                  ...
                  children: [
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            if (savedNominees.length < 3 && totalShare < 100 ||
                                editingIndex != null)
                              Column(
                                children: [
                                  Wrap(
                    ...
                    //     children: [
                    //       if (savedNominees.length < 3 &&
                    //           totalShare < 100) // Add this condition
                    //         Column(
                    //           children: [
                    //             TextButton(
                    //               onPressed: () {
                    ...
                    //                 setState(() {
                    //                   // Reset error messages
                    //                   nomineeError = nomineePanError =
                    //                       nomineedobError = nomineeShareError =
                    //                           relationshipError = null;
                    ...
                    //                     hasError = true;
                    //                   }
                    //                   if (nomineeShareText.text
                    //                       .trim()
                    //                       .isEmpty) {
                    //                     nomineeShareError =
                    //                         'Nominee share is required.';
                    //                     hasError = true;
                    //                   }
                    //                   // PAN Number Validation
                    //                   String pan = nomineePanText.text
                    //                       .trim()
                    //                       .toUpperCase();
                    //                   RegExp panRegExp =
